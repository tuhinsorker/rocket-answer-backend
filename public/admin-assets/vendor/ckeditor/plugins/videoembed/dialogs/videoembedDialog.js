...
CKEDITOR.dialog.add('videoembedDialog', function (editor) {
    return {
        ...
        onOk: function () {
            ...
            if (url.length > 1) {
                var iframe = new CKEDITOR.dom.element.createFromHtml('<iframe frameborder="0" width="100%" height="500" src="' + url + '" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');
