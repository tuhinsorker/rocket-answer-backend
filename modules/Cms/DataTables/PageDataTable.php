...
class PageDataTable extends DataTable
{
    ...
    {
        $type = 1; // Means need to fetch page type data from post table
    ...
    private function statusBtn($post) : string
    {
        ...
        $status = '<div class="btn-group">
                    ...
                    <div class="dropdown-menu" style="margin: 0px;">
                        <a class="dropdown-item" href="javascript:void(0)" id="status_1" onclick="pageStatusUpdate(\'' . route('cms.page-status-update', $post->id) . '\',' . $post->id . ',\'' . 1 . '\')">Active</a>
                        <a class="dropdown-item" href="javascript:void(0)" id="status_0" onclick="pageStatusUpdate(\'' . route('cms.page-status-update', $post->id) . '\',' . $post->id . ',\'' . 0 . '\')">Inctive</a>
                    </div>
                </div>';
