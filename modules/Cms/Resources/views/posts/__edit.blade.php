            ...
            <form action="{{route('cms.posts.update',$post->id)}}" method="Post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 cust_border pb-3 mb-3">
                        ...
                        <input type="title"  name="title" id="title" value="{{$post->title}}" class="form-control" placeholder="Title"  required>
                    </div>
                    ...
                    <div class="col-md-3 cust_border pb-3 mb-3">
                        ...
                        <select class="form-select search_test" id="category_id" name="category_id" required>
                            ...
                            @foreach($categories as $category)
                                <option value="{{$category->id}}" {{$post->post_category_id==$category->id?'selected':''}}>{{$category->category_name}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-md-3 cust_border pb-3 mb-3">
                        ...
                        <input type="text"  name="publish_by" id="publish_by" value="{{@$post->publish_by}}" class="form-control" placeholder="Publish By"  >
                    </div>
                    ...
                    <div class="col-md-12 border pb-3 mb-3">
                        ...
                        <textarea name="content" class="form-control" id="editor1" cols="30" rows="10" required>{{$post->content}}</textarea>
                    </div>
                    ...
                    <div class="col-md-6 border pb-3 mb-3">
                        ...
                        <textarea name="meta_title" id="meta_title" class="form-control" id="" cols="30" rows="1" >{{$post->meta_title}}</textarea>
                    </div>
