                    ...
                    <tbody>
                        @forelse($lists as $key => $testi)
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0)" class="btn btn-success-soft btn-sm me-1" id="editAction" data-edit-route="{{ route('cms.how-it-work-edit',$testi->id) }}" data-update-route="{{ route('cms.how-it-work-update',$testi->id) }}" ><i class="far fa-edit"></i></a>
                                    {{-- <a href="javascript:void(0)" class="btn btn-danger-soft btn-sm" id="deleteAction" data-delete-route="{{ route('cms.how-it-work-delete',$testi->id) }}"><i class="far fa-trash-alt"></i></a> --}}
                                </td>
                            </tr>
                        @empty
                            <tr>
...
<script>
    ...
    $(document).ready(function() {
            ...
            $('.addShowModal').on('click', function() {
                ...
                $('#myModal').modal('show');
                $('#ajaxForm').attr('action',"{{route('cms.how-it-work-store')}}");
            });
