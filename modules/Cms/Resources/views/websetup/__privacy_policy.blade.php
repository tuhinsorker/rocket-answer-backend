...
<x-app-layout>
    <x-card>
        ...
        <div class="card-body">
                ...
                <form action="{{route('cms.privacy-policy-update')}}"  method="POST" enctype="multipart/form-data" class="ajaxForm needs-validation" id="ajaxForm" novalidate="" data="showCallBackData" accept-charset="UTF-8">
                    @csrf
