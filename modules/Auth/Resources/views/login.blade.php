    ...
    <x-auth::card>
        <div class="">
            <div class="text-center mb-3">
                <h3 class="fs-24">{{ __('Welcome Back') }}</h3>
                <p class="text-muted text-center mb-0">
                    {{ __('Nice to see you! Please log in with your account.') }}
                </p>
            </div>
            ...
            <form class="register-form" method="POST" action="{{ route('login') }}">
                ...
                <div class="row mb-3 align-items-center">
                    ...
                    <div class="col-6 text-end">
                        <a class="text-danger" href="{{ route('password.request') }}">{{ __('Recover Password') }}</a>
                    </div>
                    @endif
                </div>
