<x-app-layout>
    ...
    <x-card>
        ...
        <x-filter-layout>
            ...
            <div class="col-md-2">
                <x-select2 name="card_type_id" id="" >
                    <option value="">Select Card Type</option>
                    @foreach (\Modules\Setting\Entities\CardTypes::get() as $expert)
            ...
            <div class="col-md-2">
                <input type="email" class="form-control" name="email" id="acount-email" placeholder="Account Email">
            </div>
            <div class="col-md-2">
