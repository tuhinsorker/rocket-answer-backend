        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="text-center">
                    ...
                    <div class="mt-3 mb-4">
                        <img class="rounded shadow-4-strong" style="max-width: 200px" alt="avatar2" src="{{ $expertWithdrawRequest?->expert?->profile_img ?? 'https://media.istockphoto.com/id/1309328823/photo/headshot-portrait-of-smiling-male-employee-in-office.jpg?b=1&s=612x612&w=0&k=20&c=eU56mZTN4ZXYDJ2SR2DFcQahxEnIl3CiqpP3SOQVbbI=' }}" />
                    </div>
                </div>
                <div class="table-responsive">
                    ...
                    <table class="table dataTable table-striped table-bordered table-hover no-footer">
                        ...
                        <tr>
                            <th>Is Approve</th>
                            <td>
                                @if ($expertWithdrawRequest->is_approve==0)
                                {!! '<span class="badge bg-warning">Pending</span>';  !!} 
                                @endif
                                @if ($expertWithdrawRequest->is_approve==1)
                                {!! '<span class="badge bg-success">Approve</span>';  !!} 
                                @endif
                                @if ($expertWithdrawRequest->is_approve==2)
