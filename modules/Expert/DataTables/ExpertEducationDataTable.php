...
class ExpertEducationDataTable extends DataTable
{
    /**
     ...
     */
    public function query(ExpertEducations $model) : QueryBuilder
    {
    ...
    public function getColumns() : array
    {
        ...
        return [
            ...
            Column::make('degree')->title(__('Degree'))->defaultContent('N/A'),
            Column::make('pass_year')->title(__('Pass Year'))->defaultContent('N/A'),
            Column::make('institute_name')->title(__('Institute Name'))->defaultContent('N/A'),
